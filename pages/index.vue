<template>
  <div>
    ...
    <!--showcase-->
    <section class="bg-info.text-dark.p-5 text-center">
      <div class="container">
        <div class="d-sm-flex">
          </div>
        </div>
    ...
    <img class="image-fluid w-100"
      src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRVj-ryPESeyIk2My2k58IhO9g5WBCV6TnMdJteu8HRwq8Dqk9rzZzzpQ1zJ3y3AIIrSPI&usqp=CAU.jpg"
      alt="">
    <!-- Footer -->
          ...
          <div class="row mt-3">
            ...
            <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
              ...
              <h6 class="text-uppercase fw-bold mb-4">
                <i class="fas fa-gem me-3"></i>Stima Company Limited
              </h6>
              <p>
                stima@facebook
              </p>
            ...
            <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
              ...
              <p><i class="fas fa-home me-3"></i> Nairobi, Nrb 10012, Kenya</p>
              <p>
